...
class veteranConfig {
  function getWheelSettingsStatus() { return [eucData.pedalMode.toString()]; }
  function getConfigWithStatusDict() { return [dictPedalStatus]; }
  function getConfigWithStatusLabels() { return ["Pedal Mode"]; }
  function getConfig() {
  ...
  function getConfigToLock() { return ["Pedal Mode"]; }
...
class kingsongConfig {
  function getWheelSettingsStatus() { return []; }
  function getConfigWithStatusDict() { return []; }
  function getConfigWithStatusLabels() { return []; }
  function getConfig() {
...
class inmotionConfig {
  ...
  function getConfigToLock() { return []; }
...
class dummyConfig {
  ...
  function getConfigLabels() { return []; }
  function getConfigToLock() { return []; }
}
